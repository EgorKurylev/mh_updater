...
autoupdate("https://raw.githubusercontent.com/EgorKurylev/mh_updater/main/updater.json", '['..string.upper(thisScript().name)..']: ', "https://raw.githubusercontent.com/EgorKurylev/mh_updater/main/updater.json")
